...
namespace Instrumentation\Bridge\OpenTelemetry;
...
/**
 * Duplicate to  OpenTelemetry\SDK\Trace\SpanProcessor\BatchSpanProcessor
 * Waiting for https://github.com/open-telemetry/opentelemetry-php/issues/852 to be fixed
 */
