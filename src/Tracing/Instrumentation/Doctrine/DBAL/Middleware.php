...
{
    public function __construct(private TracerProviderInterface $tracerProvider, private DoctrineConnectionAttributeProviderInterface $attributeProvider)
    {
    }

    public function wrap(BaseDriver $driver): BaseDriver
    {
        return new Driver($this->tracerProvider, $this->attributeProvider, $driver);
    }
}
